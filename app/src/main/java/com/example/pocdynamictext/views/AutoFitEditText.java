package com.example.pocdynamictext.views;
...
public class AutoFitEditText extends AppCompatEditText {
    ...
    private static final String TAG = AutoFitEditText.class.getSimpleName() + "_TAG";
    ...
    private boolean _firstLimit = false;


    public  void setFirstLimit(boolean b){
        this._firstLimit = b;
    }
    public  boolean isFirstLimitReached(){
        return _firstLimit;
    }

    public AutoFitEditText(final Context context) {
        this(context, null, 0);
        Log.d(TAG, "AutoFitEditText: C1");
    }

    public AutoFitEditText(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
        Log.d(TAG, "AutoFitEditText: C2");
    }

    public AutoFitEditText(final Context context, final AttributeSet attrs,
                           final int defStyle) {
        super(context, attrs, defStyle);
        Log.d(TAG, "AutoFitEditText: C3");
...
//        if(!_firstLimit) {
//            Toast.makeText(getContext(), "Font is resizing now", Toast.LENGTH_SHORT).show();
            _firstLimit = true;
      //  }
    }
